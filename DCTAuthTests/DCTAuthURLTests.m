...
- (void)testAddQuery1 {
	...
	XCTAssertTrue([[URL absoluteString] isEqualToString:expected], @"%@ should be %@", URL, expected);
}
...
- (void)testAddQuery4 {
	...
	XCTAssertTrue((expected1True || expected2True), @"%@ should be either %@ or %@", URL, expected1, expected2);
}
